...
Google Cloud NetApp Volumes를 처음 사용하거나 새 위치에서 사용하는 경우 Google Cloud NetApp Volumes를 설정하고 NFS 또는 SMB 볼륨을 생성하려면 몇 가지 초기 구성이 필요합니다. link:https://cloud.google.com/netapp/volumes/docs/before-you-begin/application-resilience["시작하기 전에"^]을 참조하십시오.
