...
NOTE: Trident는 Google Cloud NetApp Volumes에서 NAS 및 SAN 워크로드에 대해 별도의 백엔드를 사용합니다.  `google-cloud-netapp-volumes` 백엔드는 파일 기반 프로토콜만 지원하며 iSCSI 볼륨 프로비저닝에는 사용할 수 없습니다.


NOTE: iSCSI 블록 볼륨을 프로비저닝하려면 
