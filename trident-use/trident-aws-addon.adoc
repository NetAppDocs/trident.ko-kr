...
+
image::../media/aws-eks-01.png[EKS 클러스터 Add-ons 탭]

. AWS Marketplace 애드온 * 으로 이동하여 _STORAGE_CATEGORY를 선택합니다.
+
image::../media/aws-eks-02.png[AWS Marketplace 추가 기능 스토리지 범주]

. NetApp Trident * 를 찾아 Trident 애드온의 확인란을 선택하고 * 다음 * 을 클릭합니다.
. 원하는 추가 기능 버전을 선택합니다.
+
image::../media/aws-eks-03.png[Trident 추가 기능 버전 선택]

. 필요한 추가 기능 설정을 구성합니다.
+
image::../media/aws-eks-04.png[Trident 추가 기능 구성 설정]
...
+
image::../media/aws-eks-05.png[Trident 추가 기능 활성 상태]
...
----
. 설정을 계속 진행하여 스토리지 백엔드를 구성하십시오. 자세한 내용은 link:trident-fsx-storage-backend.html["스토리지 백엔드를 구성합니다"]를 참조하십시오.
