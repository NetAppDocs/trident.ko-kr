...
Trident는 볼륨 생성 시에만 자동 계층화 설정을 적용합니다. Trident 26.06에서는 프로비저닝 후 변경이 지원되지 않습니다.
...
== Trident 26.06에서 지원되는 기능

Trident 26.06는 Google Cloud NetApp Volumes에 대해 다음과 같은 자동 계층화 기능을 지원합니다.
