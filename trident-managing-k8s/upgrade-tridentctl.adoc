...
.시작하기 전에
업그레이드하기 전에 link:upgrade-trident.html#step-3-select-an-upgrade-method["업그레이드 방법을 선택합니다"]를 검토한 후  `tridentctl`를 사용하십시오.
...
----
. Trident를 다시 설치합니다. link:../trident-install/kubernetes-deploy-tridentctl.html["tridentctl을 사용하여 Trident를 설치합니다"]을 참조하십시오.
