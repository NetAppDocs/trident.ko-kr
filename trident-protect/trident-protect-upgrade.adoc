...
* 4개 릴리스 기간 외의 버전에서 업그레이드하는 경우 여러 단계를 거쳐 업그레이드하십시오. link:../earlier-versions.html["이전 버전"]에서 업그레이드하는 경우 해당 버전의 업그레이드 지침을 사용하여 4개 릴리스 기간에 맞는 최신 릴리스로 업그레이드하십시오. 예를 들어 24.10 버전을 실행 중이고 26.06으로 업그레이드하려는 경우:
+
.. 먼저 24.10에서 25.02으로 업그레이드하십시오.
.. 그다음 25.02에서 26.06으로 업그레이드하세요.
