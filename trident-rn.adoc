...
+
보다link:trident-protect-protect-apps.html["지원되는 백업 및 일정 주석"^] .



* 백업 CR에서 사용될 PVC 바인딩 시간 초과를 구성하기 위해 일정 CR에 주석을 추가했습니다. `protect.trident.netapp.io/pvc-bind-timeout-sec` . 보다link:trident-protect-protect-apps.html["지원되는 백업 및 일정 주석"^] .
