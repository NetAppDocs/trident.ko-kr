...
* *온프레미스 ONTAP* - Trident는 NFSv3를 통한 Kerberos 암호화 및 Red Hat OpenShift 및 업스트림 Kubernetes 클러스터에서 온프레미스 ONTAP 볼륨으로의 연결을 지원합니다.
...
* Kerberos 암호화와 함께 사용하는 모든 볼륨이 올바르게 구성되었는지 확인하십시오.  https://www.netapp.com/media/16398-tr-3580.pdf["NetApp 기능 향상 및 모범 사례 가이드"^]의 NetApp 도메인 구성 섹션(13페이지)을 참조하십시오.
...
.액세스 프로토콜
NFS, NFSv3 및 액세스 프로토콜을 사용하여 내보내기 정책을 구성합니다.
