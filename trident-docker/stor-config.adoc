...
디렉토리에 액세스하기 위한 NAS `.snapshot` 옵션입니다.
 a| 
 `.snapshot` 디렉터리에 대한 액세스를 활성화 또는 비활성화합니다.

유효값: `true`, `false`. 기본 동작은 ONTAP 및 Trident 버전에 따라 다를 수 있습니다. 일관된 동작을 보장하려면 명시적으로 설정하십시오.
...
FlexGroups 및 FlexGroups에 적합한 워크로드에 대한 자세한 내용은 https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["NetApp FlexGroup 볼륨 모범 사례 및 구축 가이드 를 참조하십시오"^]을 참조하십시오.
